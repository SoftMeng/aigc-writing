#!/usr/bin/env python3
"""
为《我逛漫展的那些年》第33章生成多张女角色战斗插图
角色：甘雨、可莉、胡桃、宵宫、莫娜、纳西妲、妮露、云堇、申鹤、神里绫华
"""
...
print(f"已生成 {len(prompts)} 个角色的战斗提示词")
